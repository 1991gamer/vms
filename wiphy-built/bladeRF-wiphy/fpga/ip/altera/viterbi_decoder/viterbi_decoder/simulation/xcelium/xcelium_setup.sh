...
# ACDS 23.1 993 linux 2025.01.01.20:40:11
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/spatula/intelFPGA_lite/23.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/vi_interface.vhd"                -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/vi_functions.vhd"                -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_add_tre.vhd"             -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_sel.vhd"                 -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_ram.vhd"                 -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_top.vhd"                 -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_dspip_avalon_str_ctrl.vhd"   -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_var_enc.vhd"             -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_trb_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_par_trb_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_acs_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_bmp_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_met_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_ber_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_top_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_hyb_sur_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_par_bmp_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_par_ber_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/cadence/auk_vit_par_top_atl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/viterbi_decoder_viterbi_ii_0.v"      -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/viterbi_decoder.v"                                                                                        
fi
